...
{
0xd2, 0x17, 0xfa, 0x07, 0x3b, 0xc5, 0x5d, 0x86, 0xf9, 0x45, 0x46, 0x9e, 0xef, 0xfc, 0x87, 0x10, 
0xf1, 0xe6, 0x92, 0xc2, 0x49, 0xa7, 0x34, 0xbf, 0xfe, 0x4b, 0x71, 0xc4, 0x2a, 0x84, 0xae, 0x7c, 
0xc1, 0xf9, 0x23, 0x50, 0x03, 0x56, 0x63, 0xaa, 0x43, 0x4e, 0xd6, 0x0d, 0x57, 0x81, 0xc8, 0x87, 
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_20 ) = {
	.len=19,
	.data={0x08,0x16,0x00,0xc1,0xf9,0x23,0x50,0x03,0x56,0x63,0xaa,0x43,0x4e,0xd6,0x0d,0x57,0x81,0xc8,0x87,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_17 ) = {
	.len=19,
	.data={0x10,0x13,0x00,0xf1,0xe6,0x92,0xc2,0x49,0xa7,0x34,0xbf,0xfe,0x4b,0x71,0xc4,0x2a,0x84,0xae,0x7c,}
};
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_16 ) = {
	.len=16,
	.data={0xd2,0x17,0xfa,0x07,0x3b,0xc5,0x5d,0x86,0xf9,0x45,0x46,0x9e,0xef,0xfc,0x87,0x10,}
};
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_15 ) = {
	.len=9,
	.data={0x48,0x61,0x69,0x67,0x68,0x54,0x65,0x63,0x68,}
};
...
uint8_t bg_gattdb_data_attribute_field_10_data[5]={0x4d,0x43,0x49,0x47,0x4e,};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x000a,.permissions=0x801,.caps=0xffff,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_5},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.min_key_size=0x00,.constdata=&bg_gattdb_data_attribute_field_6},
    {.uuid=0x000b,.permissions=0x803,.caps=0xffff,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_7},
    ...
    {.uuid=0x0004,.permissions=0x801,.caps=0xffff,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_10},
    ...
    {.uuid=0x8001,.permissions=0x800,.caps=0xffff,.datatype=0x07,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_18},
    {.uuid=0x000c,.permissions=0x807,.caps=0xffff,.datatype=0x03,.min_key_size=0x00,.configdata={.flags=0x01,.index=0x04,.clientconfig_index=0x01}},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.min_key_size=0x00,.constdata=&bg_gattdb_data_attribute_field_20},
    {.uuid=0x8002,.permissions=0x802,.caps=0xffff,.datatype=0x02,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_21},
};
